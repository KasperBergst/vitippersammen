...
export default class ProfileUI{
	static loadProfile(){
		...
		div.innerHTML = 
		`
		<div id="profileContent" style="display: flex; flex-direction: column; align-items: center; justify-content; center; width: 98%; height: 100%;">
			...
			<div style="display: flex; justify-content: center; width: 100%; ">
				...
				<hr color="black" style="width: 2px;">
				<div style="width: 45%; display: flex; flex-direction: column; align-items: center;">
		...
		// disable name button and profile button and footer
		...
		document.getElementById("backButton").addEventListener("click", (event) => {
			...
			div.innerHTML = "";
			div.style.display = "none"; // remove the object from the page
		});
