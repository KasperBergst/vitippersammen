 ...
 * @return if request was unsuccessful undefined. If request was of type SELECT it returns the retrieved rows. If the request was of type UPDATE, INSERT or DELETE it returns the number of rows affected.
 */ 
